...
int main(void)
{
  ...
  while (1)
  {
	// Format the data as "x y pen_status" where pen_status is 1 (up) or 0 (down)
//	snprintf(touch_data, sizeof(touch_data), "%u %u %d\n", 2, 2, 1);
//	HAL_UART_Transmit(&huart3, (uint8_t *)touch_data, 64, HAL_MAX_DELAY);
